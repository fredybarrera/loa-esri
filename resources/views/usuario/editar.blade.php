...
@section('content')
    ...
    @if (Session::has('message'))
        <div class="alert alert-{!! (Session::get('type') == 'success') ? 'success' : 'danger' !!} alert-dismissible fade in">
                ...
                <div class="tab-pane fade show active" id="user-edit-account">
                    ...
                    <div class="card-body pb-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control mb-1" value="{{$item->email}}" required>
