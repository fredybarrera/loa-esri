...
var captions = {
  ...
  update: function update() {
    ...
    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_4__["toggleClass"])(this.elements.container, this.config.classNames.captions.enabled, !_utils_is__WEBPACK_IMPORTED_MODULE_8__["default"].empty(tracks)); // Update available languages in list
  ...
  toggle: function toggle(input) {
    ...
    var active = _utils_is__WEBPACK_IMPORTED_MODULE_8__["default"].nullOrUndefined(input) ? !toggled : input; // Update state and trigger event
    ...
    if (active !== toggled) {
      ...
      _controls__WEBPACK_IMPORTED_MODULE_0__["default"].updateSetting.call(this, 'captions'); // Trigger event (not used internally)
  ...
  set: function set(index) {
    ...
    if (this.captions.currentTrack !== index) {
      ...
      _controls__WEBPACK_IMPORTED_MODULE_0__["default"].updateSetting.call(this, 'captions'); // When passive, don't override user preferences
...
var controls = {
  ...
  findElements: function findElements() {
    try {
      this.elements.controls = _utils_elements__WEBPACK_IMPORTED_MODULE_7__["getElement"].call(this, this.config.selectors.controls.wrapper); // Buttons
      ...
      this.elements.progress = _utils_elements__WEBPACK_IMPORTED_MODULE_7__["getElement"].call(this, this.config.selectors.progress); // Inputs
  ...
  createButton: function createButton(buttonType, attr) {
    ...
    var button = Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["createElement"])(props.element); // Setup toggle icon and labels
    ...
    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["setAttributes"])(button, attributes); // We have multiple play buttons
  ...
  bindMenuItemShortcuts: function bindMenuItemShortcuts(menuItem, type) {
    ...
    _utils_events__WEBPACK_IMPORTED_MODULE_8__["on"].call(this, menuItem, 'keydown keyup', function (event) {
      ...
      var isRadioButton = Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["matches"])(menuItem, '[role="menuitemradio"]'); // Show the respective menu
  ...
  createMenuItem: function createMenuItem(_ref) {
    ...
    var flex = Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["createElement"])('span'); // We have to set as HTML incase of special characters
  ...
  updateProgress: function updateProgress(event) {
    ...
    var setProgress = function setProgress(target, input) {
      ...
      var progress = _utils_is__WEBPACK_IMPORTED_MODULE_10__["default"].element(target) ? target : _this4.elements.display.buffer; // Update value and label
    ...
    if (event) {
      switch (event.type) {
        ...
        case 'seeking':
        case 'seeked':
          value = Object(_utils_strings__WEBPACK_IMPORTED_MODULE_13__["getPercentage"])(this.currentTime, this.duration); // Set seek range value only if it's a 'natural' time event
  ...
  updateRangeFill: function updateRangeFill(target) {
    ...
    var range = _utils_is__WEBPACK_IMPORTED_MODULE_10__["default"].event(target) ? target.target : target; // Needs to be a valid <input type='range'>
  ...
  timeUpdate: function timeUpdate(event) {
    ...
    var invert = !_utils_is__WEBPACK_IMPORTED_MODULE_10__["default"].element(this.elements.display.duration) && this.config.invertTime; // Duration
  ...
  durationUpdate: function durationUpdate() {
    ...
    var hasDuration = _utils_is__WEBPACK_IMPORTED_MODULE_10__["default"].element(this.elements.display.duration); // If there's only one time display, display duration there
  ...
  updateSetting: function updateSetting(setting, container, input) {
    ...
    if (setting === 'captions') {
      ...
      value = !_utils_is__WEBPACK_IMPORTED_MODULE_10__["default"].empty(input) ? input : this[setting]; // Get default
  ...
  setQualityMenu: function setQualityMenu(options) {
    ...
    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["emptyElement"])(list); // Check if we need to toggle the parent
  ...
  toggleMenu: function toggleMenu(input) {
    ...
    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["toggleHidden"])(popup, !show); // Add class hook

    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["toggleClass"])(this.elements.container, this.config.classNames.menu.open, show); // Focus the first item if key interaction
  ...
  showMenuPanel: function showMenuPanel() {
    ...
    if (_support__WEBPACK_IMPORTED_MODULE_3__["default"].transitions && !_support__WEBPACK_IMPORTED_MODULE_3__["default"].reducedMotion) {
      ...
      var restore = function restore(event) {
        ...
        _utils_events__WEBPACK_IMPORTED_MODULE_8__["off"].call(_this9, container, _utils_animation__WEBPACK_IMPORTED_MODULE_4__["transitionEndEvent"], restore);
      }; // Listen for the transition finishing and restore auto height/width


      _utils_events__WEBPACK_IMPORTED_MODULE_8__["on"].call(this, container, _utils_animation__WEBPACK_IMPORTED_MODULE_4__["transitionEndEvent"], restore); // Set dimensions to target
    ...
    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["toggleHidden"])(current, true); // Set attributes on target

    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["toggleHidden"])(target, false); // Focus the first item
  ...
  create: function create(data) {
    ...
    Object(_utils_arrays__WEBPACK_IMPORTED_MODULE_5__["dedupe"])(this.config.controls).forEach(function (control) {
      ...
      if (control === 'progress') {
        ...
        var progress = Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["createElement"])('div', Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["getAttributesFromSelector"])(_this10.config.selectors.progress)); // Seek range slider
      ...
      if (control === 'settings' && !_utils_is__WEBPACK_IMPORTED_MODULE_10__["default"].empty(_this10.config.settings)) {
        ...
        _this10.config.settings.forEach(function (type) {
          ...
          backButton.appendChild(Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["createElement"])('span', {
            'aria-hidden': true
          }, _utils_i18n__WEBPACK_IMPORTED_MODULE_9__["default"].get(type, _this10.config))); // Screen reader label

          backButton.appendChild(Object(_utils_elements__WEBPACK_IMPORTED_MODULE_7__["createElement"])('span', {
            class: _this10.config.classNames.hidden
          }, _utils_i18n__WEBPACK_IMPORTED_MODULE_9__["default"].get('menuBack', _this10.config))); // Go back via keyboard
  ...
  inject: function inject() {
    ...
    if (_utils_is__WEBPACK_IMPORTED_MODULE_10__["default"].element(this.config.controls) || _utils_is__WEBPACK_IMPORTED_MODULE_10__["default"].string(this.config.controls)) {
      ...
      container = controls.create.call(this, {
        ...
        captions: _captions__WEBPACK_IMPORTED_MODULE_1__["default"].getLabel.call(this) // TODO: Looping
        // loop: 'None',
...
var Fullscreen = /*#__PURE__*/function () {
  ...
  _createClass(Fullscreen, [{
    ...
    value: function toggleFallback() {
      ...
      Object(_utils_elements__WEBPACK_IMPORTED_MODULE_1__["toggleClass"])(this.target, this.player.config.classNames.fullscreen.fallback, toggle); // Force full viewport on iPhone X+
...
/* harmony import */ var _utils_events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/events */ "./node_modules/plyr/src/js/utils/events.js");
/* harmony import */ var _utils_is__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/is */ "./node_modules/plyr/src/js/utils/is.js");
/* harmony import */ var _utils_style__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/style */ "./node_modules/plyr/src/js/utils/style.js");
// ==========================================================================
// Plyr HTML5 helpers
// ==========================================================================
...
var html5 = {
  ...
  cancelRequests: function cancelRequests() {
    ...
    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_1__["removeElement"])(html5.getSources.call(this)); // Set blank video src attribute
...
/* harmony import */ var _utils_style__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/style */ "./node_modules/plyr/src/js/utils/style.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
var Listeners = /*#__PURE__*/function () {
  ...
  _createClass(Listeners, [{
    ...
    value: function global() {
      ...
      _utils_events__WEBPACK_IMPORTED_MODULE_5__["toggleListener"].call(player, document.body, 'click', this.toggleMenu, toggle); // Detect touch by events

      _utils_events__WEBPACK_IMPORTED_MODULE_5__["once"].call(player, document.body, 'touchstart', this.firstTouch); // Tab focus detection
    ...
    value: function container() {
      ...
      _utils_events__WEBPACK_IMPORTED_MODULE_5__["on"].call(player, elements.container, 'mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen', function (event) {
        ...
        if (show) {
          _ui__WEBPACK_IMPORTED_MODULE_1__["default"].toggleControls.call(player, true); // Use longer timeout for touch devices
    ...
    value: function media() {
      ...
      if (player.supported.ui && player.config.clickToPlay && !player.isAudio) {
        ...
        var wrapper = _utils_elements__WEBPACK_IMPORTED_MODULE_4__["getElement"].call(player, ".".concat(player.config.classNames.video)); // Bail if there's no wrapper (this should never happen)
      ...
      _utils_events__WEBPACK_IMPORTED_MODULE_5__["on"].call(player, player.media, 'ratechange', function () {
        // Update UI
        _controls__WEBPACK_IMPORTED_MODULE_0__["default"].updateSetting.call(player, 'speed'); // Save to storage
    ...
    value: function controls() {
      ...
      var inputEvent = _utils_browser__WEBPACK_IMPORTED_MODULE_3__["default"].isIE ? 'change' : 'input'; // Play/pause toggle
      ...
      this.bind(elements.controls, 'focusin', function () {
        ...
        Object(_utils_elements__WEBPACK_IMPORTED_MODULE_4__["toggleClass"])(elements.controls, config.classNames.noTransition, true); // Toggle

        _ui__WEBPACK_IMPORTED_MODULE_1__["default"].toggleControls.call(player, true); // Restore transition
...
var media = {
  ...
  setup: function setup() {
    ...
    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_3__["toggleClass"])(this.elements.container, this.config.classNames.type.replace('{0}', this.type), true); // Add provider class

    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_3__["toggleClass"])(this.elements.container, this.config.classNames.provider.replace('{0}', this.provider), true); // Add video class for embeds
    ...
    if (this.isVideo) {
      ...
      Object(_utils_elements__WEBPACK_IMPORTED_MODULE_3__["wrap"])(this.media, this.elements.wrapper); // Faux poster container
...
/* harmony import */ var _utils_is__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/is */ "./node_modules/plyr/src/js/utils/is.js");
/* harmony import */ var _utils_time__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/time */ "./node_modules/plyr/src/js/utils/time.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
  ...
  _createClass(PreviewThumbnails, [{
    ...
    value: function getThumbnails() {
      ...
      return new Promise(function (resolve) {
        ...
        var urls = _utils_is__WEBPACK_IMPORTED_MODULE_3__["default"].string(src) ? [src] : src; // Loop through each src URL. Download and process the VTT file, storing the resulting data in this.thumbnails
...
/* harmony import */ var _utils_strings__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/strings */ "./node_modules/plyr/src/js/utils/strings.js");
/* harmony import */ var _utils_style__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/style */ "./node_modules/plyr/src/js/utils/style.js");
/* harmony import */ var _utils_urls__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/urls */ "./node_modules/plyr/src/js/utils/urls.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
var vimeo = {
  setup: function setup() {
    ...
    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_3__["toggleClass"])(player.elements.wrapper, player.config.classNames.embed, true); // Set speed options from config

    player.options.speed = player.config.speed.options; // Set intial ratio

    _utils_style__WEBPACK_IMPORTED_MODULE_10__["setAspectRatio"].call(player); // Load the SDK if not already
  ...
  ready: function ready() {
    ...
    player.media = Object(_utils_elements__WEBPACK_IMPORTED_MODULE_3__["replaceElement"])(wrapper, player.media); // Get poster image
    ...
    Object.defineProperty(player.media, 'currentTime', {
      ...
      set: function set(time) {
        ...
        media.seeking = true;
        _utils_events__WEBPACK_IMPORTED_MODULE_4__["triggerEvent"].call(player, media, 'seeking'); // If paused, mute until seek is complete
    ...
    player.embed.on('progress', function (data) {
      ...
      _utils_events__WEBPACK_IMPORTED_MODULE_4__["triggerEvent"].call(player, player.media, 'progress'); // Check all loaded
...
var youtube = {
  setup: function setup() {
    ...
    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_1__["toggleClass"])(this.elements.wrapper, this.config.classNames.embed, true); // Setup API
  ...
  getTitle: function getTitle(videoId) {
    ...
    Object(_utils_fetch__WEBPACK_IMPORTED_MODULE_3__["default"])(url).then(function (data) {
      if (_utils_is__WEBPACK_IMPORTED_MODULE_4__["default"].object(data)) {
        ...
        _ui__WEBPACK_IMPORTED_MODULE_0__["default"].setTitle.call(_this2); // Set aspect ratio
  ...
  ready: function ready() {
    ...
    var id = Object(_utils_strings__WEBPACK_IMPORTED_MODULE_8__["generateId"])(player.provider); // Get poster, if already set
    ...
    player.media = Object(_utils_elements__WEBPACK_IMPORTED_MODULE_1__["replaceElement"])(container, player.media); // Id to poster wrapper
      ...
      events: {
        ...
        onReady: function onReady(event) {
          ...
          Object.defineProperty(player.media, 'currentTime', {
            ...
            set: function set(time) {
              ...
              _utils_events__WEBPACK_IMPORTED_MODULE_2__["triggerEvent"].call(player, player.media, 'seeking'); // Seek after events sent
          ...
          _utils_events__WEBPACK_IMPORTED_MODULE_2__["triggerEvent"].call(player, player.media, 'durationchange'); // Reset timer
        ...
        onStateChange: function onStateChange(event) {
          ...
          switch (event.data) {
            case -1:
              // Update scrubber
              _utils_events__WEBPACK_IMPORTED_MODULE_2__["triggerEvent"].call(player, player.media, 'timeupdate'); // Get loaded % from YouTube
            ...
            case 1:
              ...
              if (!player.config.autoplay && player.media.paused && !player.embed.hasPlayed) {
                ...
                assurePlaybackState.call(player, true);
                _utils_events__WEBPACK_IMPORTED_MODULE_2__["triggerEvent"].call(player, player.media, 'playing'); // Poll to get playback progress
...
/* harmony import */ var _plugins_preview_thumbnails__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./plugins/preview-thumbnails */ "./node_modules/plyr/src/js/plugins/preview-thumbnails.js");
/* harmony import */ var _source__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./source */ "./node_modules/plyr/src/js/source.js");
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./storage */ "./node_modules/plyr/src/js/storage.js");
/* harmony import */ var _support__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./support */ "./node_modules/plyr/src/js/support.js");
/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./ui */ "./node_modules/plyr/src/js/ui.js");
/* harmony import */ var _utils_arrays__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./utils/arrays */ "./node_modules/plyr/src/js/utils/arrays.js");
/* harmony import */ var _utils_elements__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./utils/elements */ "./node_modules/plyr/src/js/utils/elements.js");
/* harmony import */ var _utils_events__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./utils/events */ "./node_modules/plyr/src/js/utils/events.js");
/* harmony import */ var _utils_is__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./utils/is */ "./node_modules/plyr/src/js/utils/is.js");
/* harmony import */ var _utils_load_sprite__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./utils/load-sprite */ "./node_modules/plyr/src/js/utils/load-sprite.js");
/* harmony import */ var _utils_numbers__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./utils/numbers */ "./node_modules/plyr/src/js/utils/numbers.js");
/* harmony import */ var _utils_objects__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./utils/objects */ "./node_modules/plyr/src/js/utils/objects.js");
/* harmony import */ var _utils_style__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./utils/style */ "./node_modules/plyr/src/js/utils/style.js");
/* harmony import */ var _utils_urls__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./utils/urls */ "./node_modules/plyr/src/js/utils/urls.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
var Plyr = /*#__PURE__*/function () {
  function Plyr(target, options) {
    ...
    this.touch = _support__WEBPACK_IMPORTED_MODULE_13__["default"].touch; // Set the media element
    ...
    this.debug = new _console__WEBPACK_IMPORTED_MODULE_4__["default"](this.config.debug); // Log config options and support

    this.debug.log('Config', this.config);
    this.debug.log('Support', _support__WEBPACK_IMPORTED_MODULE_13__["default"]); // We need an element to setup
    ...
    switch (type) {
      case 'div':
        ...
        if (_utils_is__WEBPACK_IMPORTED_MODULE_18__["default"].element(iframe)) {
          ...
          this.provider = Object(_config_types__WEBPACK_IMPORTED_MODULE_3__["getProviderByUrl"])(url.toString()); // Rework elements
      ...
      case 'audio':
        this.type = type;
        this.provider = _config_types__WEBPACK_IMPORTED_MODULE_3__["providers"].html5; // Get config from attributes
    ...
    this.supported = _support__WEBPACK_IMPORTED_MODULE_13__["default"].check(this.type, this.provider, this.config.playsinline); // If no support for even API, bail
    ...
    this.listeners = new _listeners__WEBPACK_IMPORTED_MODULE_7__["default"](this); // Setup local storage for user settings

    this.storage = new _storage__WEBPACK_IMPORTED_MODULE_12__["default"](this); // Store reference
    ...
    _ui__WEBPACK_IMPORTED_MODULE_14__["default"].addStyleHook.call(this); // Setup media

    _media__WEBPACK_IMPORTED_MODULE_8__["default"].setup.call(this); // Listen for events if debugging
    ...
    this.fullscreen = new _fullscreen__WEBPACK_IMPORTED_MODULE_6__["default"](this); // Setup ads if provided
  ...
  _createClass(Plyr, [{
    ...
    value: function toggleControls(toggle) {
      ...
      if (this.supported.ui && !this.isAudio) {
        ...
        var isHidden = Object(_utils_elements__WEBPACK_IMPORTED_MODULE_16__["hasClass"])(this.elements.container, this.config.classNames.hideControls); // Negate the argument if not undefined since adding the class to hides the controls

        var force = typeof toggle === 'undefined' ? undefined : !toggle; // Apply and get updated state

        var hiding = Object(_utils_elements__WEBPACK_IMPORTED_MODULE_16__["toggleClass"])(this.elements.container, this.config.classNames.hideControls, force); // Close menu
    ...
    value: function destroy(callback) {
      ...
      var done = function done() {
        ...
        if (soft) {
          if (Object.keys(_this3.elements).length) {
            // Remove elements
            Object(_utils_elements__WEBPACK_IMPORTED_MODULE_16__["removeElement"])(_this3.elements.buttons.play);
            Object(_utils_elements__WEBPACK_IMPORTED_MODULE_16__["removeElement"])(_this3.elements.captions);
            Object(_utils_elements__WEBPACK_IMPORTED_MODULE_16__["removeElement"])(_this3.elements.controls);
            Object(_utils_elements__WEBPACK_IMPORTED_MODULE_16__["removeElement"])(_this3.elements.wrapper); // Clear for GC
          ...
          // Unbind listeners
          _utils_events__WEBPACK_IMPORTED_MODULE_17__["unbindListeners"].call(_this3); // Replace the container with the original element provided

          Object(_utils_elements__WEBPACK_IMPORTED_MODULE_16__["replaceElement"])(_this3.elements.original, _this3.elements.container); // Event

          _utils_events__WEBPACK_IMPORTED_MODULE_17__["triggerEvent"].call(_this3, _this3.elements.original, 'destroyed', true); // Callback
      ...
      if (this.isHTML5) {
        ...
        _ui__WEBPACK_IMPORTED_MODULE_14__["default"].toggleNativeControls.call(this, true); // Clean up
    ...
    set: function set(input) {
      ...
      var inputIsValid = _utils_is__WEBPACK_IMPORTED_MODULE_18__["default"].number(input) && input > 0; // Set
    ...
    get: function get() {
      ...
      var duration = !_utils_is__WEBPACK_IMPORTED_MODULE_18__["default"].number(realDuration) || realDuration === Infinity ? 0 : realDuration; // If config duration is funky, use regular duration
    ...
    set: function set(input) {
      ...
      speed = Object(_utils_numbers__WEBPACK_IMPORTED_MODULE_20__["clamp"])(speed, min, max); // Update config
    ...
    set: function set(input) {
      ...
      var toggle = _utils_is__WEBPACK_IMPORTED_MODULE_18__["default"].boolean(input) ? input : !this.pip; // Toggle based on current state
      // Safari
...
var source = {
  ...
  change: function change(input) {
    ...
    _html5__WEBPACK_IMPORTED_MODULE_1__["default"].cancelRequests.call(this); // Destroy instance and re-setup
    ...
    this.destroy.call(this, function () {
      ...
      _ui__WEBPACK_IMPORTED_MODULE_5__["default"].addStyleHook.call(_this2); // Set new sources for html5
      ...
      _media__WEBPACK_IMPORTED_MODULE_2__["default"].setup.call(_this2); // HTML5 stuff
...
var Storage = /*#__PURE__*/function () {
  ...
  _createClass(Storage, [{
    ...
    value: function set(object) {
      ...
      Object(_utils_objects__WEBPACK_IMPORTED_MODULE_1__["extend"])(storage, object); // Update storage
...
/* harmony import */ var _utils_is__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/is */ "./node_modules/plyr/src/js/utils/is.js");
/* harmony import */ var _utils_load_image__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/load-image */ "./node_modules/plyr/src/js/utils/load-image.js");
// ==========================================================================
// Plyr UI
// ==========================================================================
...
var ui = {
  ...
  build: function build() {
    ...
    if (!_utils_is__WEBPACK_IMPORTED_MODULE_7__["default"].element(this.elements.controls)) {
      ...
      _controls__WEBPACK_IMPORTED_MODULE_1__["default"].inject.call(this); // Re-attach control listeners
    ...
    _controls__WEBPACK_IMPORTED_MODULE_1__["default"].updateVolume.call(this); // Reset time display

    _controls__WEBPACK_IMPORTED_MODULE_1__["default"].timeUpdate.call(this); // Update the UI

    ui.checkPlaying.call(this); // Check for picture-in-picture support

    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_4__["toggleClass"])(this.elements.container, this.config.classNames.pip.supported, _support__WEBPACK_IMPORTED_MODULE_2__["default"].pip && this.isHTML5 && this.isVideo); // Check for airplay support

    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_4__["toggleClass"])(this.elements.container, this.config.classNames.airplay.supported, _support__WEBPACK_IMPORTED_MODULE_2__["default"].airplay && this.isHTML5); // Add iOS class

    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_4__["toggleClass"])(this.elements.container, this.config.classNames.isIos, _utils_browser__WEBPACK_IMPORTED_MODULE_3__["default"].isIos); // Add touch class

    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_4__["toggleClass"])(this.elements.container, this.config.classNames.isTouch, this.touch); // Ready for API calls
  ...
  setTitle: function setTitle() {
    ...
    var label = _utils_i18n__WEBPACK_IMPORTED_MODULE_6__["default"].get('play', this.config); // If there's a media title set, use that for the label
  ...
  setPoster: function setPoster(poster) {
    ...
    return _utils_events__WEBPACK_IMPORTED_MODULE_5__["ready"].call(this) // Load image
    .then(function () {
  ...
  checkPlaying: function checkPlaying(event) {
    ...
    Object(_utils_elements__WEBPACK_IMPORTED_MODULE_4__["toggleClass"])(this.elements.container, this.config.classNames.stopped, this.stopped); // Set state
  ...
  checkLoading: function checkLoading(event) {
    ...
    this.timers.loading = setTimeout(function () {
      ...
      Object(_utils_elements__WEBPACK_IMPORTED_MODULE_4__["toggleClass"])(_this4.elements.container, _this4.config.classNames.loading, _this4.loading); // Update controls visibility
...
function loadSprite(url, id) {
  ...
  if (!hasId || !exists()) {
    var useStorage = _storage__WEBPACK_IMPORTED_MODULE_0__["default"].supported; // Create container
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Plyr", function() { return plyr_src_js_plyr_js__WEBPACK_IMPORTED_MODULE_0__["default"]; });
...
module.exports = __webpack_require__(/*! C:\Proyectos\Esri - LOA\template\laravel-starter\resources\assets\vendor\libs\plyr\plyr.js */"./resources/assets/vendor/libs/plyr/plyr.js");
