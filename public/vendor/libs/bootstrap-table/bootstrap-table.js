...
var BootstrapTable = /*#__PURE__*/function () {
  ...
  _createClass(BootstrapTable, [{
    ...
    value: function initConstants() {
      ...
      this.constants.buttonsClass = [opts.buttonsPrefix, buttonsPrefix + opts.buttonsClass, _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf("".concat(buttonsPrefix, "%s"), opts.iconSize)].join(' ').trim();
    }
  }, {
    key: "initLocale",
    ...
    value: function initHeader() {
      ...
      this.options.columns.forEach(function (columns, i) {
        ...
        columns.forEach(function (column, j) {
          ...
          var headerStyle = _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].calculateObjectValue(null, _this2.options.headerStyle, [column]);
          var csses = [];
          var classes = '';

          if (headerStyle && headerStyle.css) {
            for (var _i2 = 0, _Object$entries = Object.entries(headerStyle.css); _i2 < _Object$entries.length; _i2++) {
          ...
          if (headerStyle && headerStyle.classes) {
            classes = _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(' class="%s"', column['class'] ? [column['class'], headerStyle.classes].join(' ') : headerStyle.classes);
          }
          ...
          html.push("<th".concat(_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(' title="%s"', column.titleTooltip)), column.checkbox || column.radio ? _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(' class="bs-checkbox %s"', column['class'] || '') : classes || class_, _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(' style="%s"', halign + style + csses.join('; ')), _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(' rowspan="%s"', column.rowspan), _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(' colspan="%s"', column.colspan), _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(' data-field="%s"', column.field), // If `column` is not the first element of `this.options.columns[0]`, then className 'data-not-first-th' should be added.
      ...
      var resizeEvent = _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].getResizeEventName(this.$el.attr('id'));
      ...
      if (index !== -1) {
        ...
        if (this.options.customSort) {
          ...
          this.data.sort(function (a, b) {
            ...
            return _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sort(aa, bb, order, _this3.options.sortStable, a._position, b._position);
          });
        }
    ...
    value: function initToolbar() {
      ...
      if (typeof opts.toolbar === 'string' || _typeof(opts.toolbar) === 'object') {
        $(_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf('<div class="bs-bars %s-%s"></div>', this.constants.classes.pull, opts.toolbarAlign)).appendTo(this.$toolbar).append($(opts.toolbar));
      ...
      var buttonsHtml = {
        paginationSwitch: "<button class=\"".concat(this.constants.buttonsClass, "\" type=\"button\" name=\"paginationSwitch\"\n        aria-label=\"Pagination Switch\" title=\"").concat(opts.formatPaginationSwitch(), "\">\n        ").concat(opts.showButtonIcons ? _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(this.constants.html.icon, opts.iconsPrefix, opts.icons.paginationSwitchDown) : '', "\n        ").concat(opts.showButtonText ? opts.formatPaginationSwitchUp() : '', "\n        </button>"),
        refresh: "<button class=\"".concat(this.constants.buttonsClass, "\" type=\"button\" name=\"refresh\"\n        aria-label=\"Refresh\" title=\"").concat(opts.formatRefresh(), "\">\n        ").concat(opts.showButtonIcons ? _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(this.constants.html.icon, opts.iconsPrefix, opts.icons.refresh) : '', "\n        ").concat(opts.showButtonText ? opts.formatRefresh() : '', "\n        </button>"),
        toggle: "<button class=\"".concat(this.constants.buttonsClass, "\" type=\"button\" name=\"toggle\"\n        aria-label=\"Toggle\" title=\"").concat(opts.formatToggle(), "\">\n        ").concat(opts.showButtonIcons ? _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(this.constants.html.icon, opts.iconsPrefix, opts.icons.toggleOff) : '', "\n        ").concat(opts.showButtonText ? opts.formatToggleOn() : '', "\n        </button>"),
        fullscreen: "<button class=\"".concat(this.constants.buttonsClass, "\" type=\"button\" name=\"fullscreen\"\n        aria-label=\"Fullscreen\" title=\"").concat(opts.formatFullscreen(), "\">\n        ").concat(opts.showButtonIcons ? _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(this.constants.html.icon, opts.iconsPrefix, opts.icons.fullscreen) : '', "\n        ").concat(opts.showButtonText ? opts.formatFullscreen() : '', "\n        </button>"),
        columns: function () {
          var html = [];
          html.push("<div class=\"keep-open ".concat(_this4.constants.classes.buttonsDropdown, "\" title=\"").concat(opts.formatColumns(), "\">\n          <button class=\"").concat(_this4.constants.buttonsClass, " dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\"\n          aria-label=\"Columns\" title=\"").concat(opts.formatColumns(), "\">\n          ").concat(opts.showButtonIcons ? _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(_this4.constants.html.icon, opts.iconsPrefix, opts.icons.columns) : '', "\n          ").concat(opts.showButtonText ? opts.formatColumns() : '', "\n          ").concat(_this4.constants.html.dropdownCaret, "\n          </button>\n          ").concat(_this4.constants.html.toolbarDropdown[0]));

          if (opts.showColumnsSearch) {
            html.push(_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(_this4.constants.html.toolbarDropdownItem, _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf('<input type="text" class="%s" id="columnsSearch" placeholder="%s" autocomplete="off">', _this4.constants.classes.input, opts.formatSearch())));
          ...
          if (opts.showColumnsToggleAll) {
            ...
            html.push(_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(_this4.constants.html.toolbarDropdownItem, _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf('<input type="checkbox" class="toggle-all" %s> <span>%s</span>', allFieldsVisible ? 'checked="checked"' : '', opts.formatColumnsToggleAll())));
            html.push(_this4.constants.html.toolbarDropdownSeparator);
          }
          ...
          _this4.columns.forEach(function (column, i) {
            ...
            if (column.switchable) {
              html.push(_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(_this4.constants.html.toolbarDropdownItem, _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf('<input type="checkbox" data-field="%s" value="%s"%s%s> <span>%s</span>', column.field, i, checked, disabled, column.title)));
              switchableCount++;
            }
          });
      ...
      if (opts.showColumns) {
        ...
        $checkboxes.off('click').on('click', function (_ref5) {
        ...
        $toggleAll.off('click').on('click', function (_ref6) {
        ...
        if (opts.showColumnsSearch) {
          ...
          $columnsSearch.on('keyup paste change', function (_ref7) {
      ...
      if (opts.search || this.showSearchClearButton) {
        html = [];
        var showSearchButton = _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(this.constants.html.searchButton, this.constants.buttonsClass, opts.formatSearch(), opts.showButtonIcons ? _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(this.constants.html.icon, opts.iconsPrefix, opts.icons.search) : '', opts.showButtonText ? opts.formatSearch() : '');
        var showSearchClearButton = _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(this.constants.html.searchClearButton, this.constants.buttonsClass, opts.formatClearSearch(), opts.showButtonIcons ? _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(this.constants.html.icon, opts.iconsPrefix, opts.icons.clearSearch) : '', opts.showButtonText ? opts.formatClearSearch() : '');
        var searchInputHtml = "<input class=\"".concat(this.constants.classes.input, "\n        ").concat(_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(' %s%s', this.constants.classes.inputPrefix, opts.iconSize), "\n        search-input\" type=\"text\" placeholder=\"").concat(opts.formatSearch(), "\" autocomplete=\"off\">");
        var searchInputFinalHtml = searchInputHtml;

        if (opts.showSearchButton || opts.showSearchClearButton) {
          var _buttonsHtml = (opts.showSearchButton ? showSearchButton : '') + (opts.showSearchClearButton ? showSearchClearButton : '');

          searchInputFinalHtml = opts.search ? _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(this.constants.html.inputGroup, searchInputHtml, _buttonsHtml) : _buttonsHtml;
        }
        ...
        var handleInputEvent = function handleInputEvent() {
          var eventTriggers = "keyup drop blur ".concat(_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].isIEBrowser() ? 'mouseup' : '');
    ...
    value: function initSearch() {
      ...
      if (this.options.sidePagination !== 'server') {
        ...
        var s = this.searchText && (this.fromHtml ? _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].escapeHTML(this.searchText) : this.searchText).toLowerCase();
          ...
          for (var j = 0; j < _this5.header.fields.length; j++) {
            ...
            if (typeof key === 'string') {
              ...
              for (var _i3 = 0; _i3 < props.length; _i3++) {
                if (value[props[_i3]] !== null) {
                  value = value[props[_i3]];
                }
              }
            } else {
              value = item[key];
    ...
    value: function initPagination() {
      ...
      if (!opts.onlyInfoPagination) {
        ...
        html.push('</span></div>');
        html.push("<div class=\"".concat(this.constants.classes.pull, "-").concat(opts.paginationHAlign, " pagination\">"), _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(this.constants.html.pagination[0], _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(' pagination-%s', opts.iconSize)), _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(this.constants.html.paginationItem, ' page-pre', opts.formatSRPaginationPreText(), opts.paginationPreText));
        ...
        var pageItem = function pageItem(i) {
          ...
          return _utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf(_this6.constants.html.paginationItem, classes + (i === opts.pageNumber ? " ".concat(_this6.constants.classes.paginationActive) : ''), opts.formatSRPaginationPageText(i), i);
        };
    ...
    value: function initRow(item, i, data, trFragments) {
      ...
      if (style && style.css) {
        for (var _i4 = 0, _Object$entries2 = Object.entries(style.css); _i4 < _Object$entries2.length; _i4++) {
          var _ref11 = _Object$entries2[_i4];
      ...
      if (attributes) {
        for (var _i5 = 0, _Object$entries3 = Object.entries(attributes); _i5 < _Object$entries3.length; _i5++) {
          var _ref14 = _Object$entries3[_i5];
      ...
      if (item._data && !_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].isEmptyObject(item._data)) {
        for (var _i6 = 0, _Object$entries4 = Object.entries(item._data); _i6 < _Object$entries4.length; _i6++) {
          var _ref17 = _Object$entries4[_i6];
      ...
      this.header.fields.forEach(function (field, j) {
        ...
        if (cellStyle.css) {
          ...
          for (var _i7 = 0, _Object$entries5 = Object.entries(cellStyle.css); _i7 < _Object$entries5.length; _i7++) {
            var _ref20 = _Object$entries5[_i7];
        ...
        if (item["_".concat(field, "_data")] && !_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].isEmptyObject(item["_".concat(field, "_data")])) {
          for (var _i8 = 0, _Object$entries6 = Object.entries(item["_".concat(field, "_data")]); _i8 < _Object$entries6.length; _i8++) {
            var _ref23 = _Object$entries6[_i8];
    ...
    value: function initFooter() {
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          ...
          if (style && style.css) {
            for (var _i9 = 0, _Object$entries7 = Object.entries(style.css); _i9 < _Object$entries7.length; _i9++) {
              var _ref26 = _Object$entries7[_i9];
    ...
    value: function getData(params) {
      ...
      if ((this.searchText || this.options.customSearch || this.options.sortName || !_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].isEmptyObject(this.filterColumns) || !_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].isEmptyObject(this.filterColumnsPartial)) && (!params || !params.unfiltered)) {
        data = this.data;
      }
    ...
    value: function updateCellByUniqueId(params) {
      ...
      var allParams = Array.isArray(params) ? params : [params];
      allParams.forEach(function (_ref27) {
        var id = _ref27.id,
            field = _ref27.field,
            value = _ref27.value;
    ...
    value: function _toggleCheckBy(checked, obj) {
      ...
      this.data.forEach(function (row, i) {
        ...
        if (obj.values.includes(row[obj.field])) {
          var $el = _this24.$selectItem.filter(':enabled').filter(_utils_index_js__WEBPACK_IMPORTED_MODULE_1__["default"].sprintf('[data-index="%s"]', i));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var bootstrap_table_src_bootstrap_table_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bootstrap-table/src/bootstrap-table.js */ "./node_modules/bootstrap-table/src/bootstrap-table.js");
...
module.exports = __webpack_require__(/*! C:\Proyectos\Esri - LOA\template\laravel-starter\resources\assets\vendor\libs\bootstrap-table\bootstrap-table.js */"./resources/assets/vendor/libs/bootstrap-table/bootstrap-table.js");
