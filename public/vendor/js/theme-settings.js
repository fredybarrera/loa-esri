...
/*!**************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/postcss-loader/src??ref--80-2!./node_modules/sass-loader/dist/cjs.js??ref--80-3!./resources/assets/vendor/js/_theme-settings/_theme-settings.scss ***!
  \**************************************************************************************************************************************************************************************************/
...
var content = __webpack_require__(/*! !../../../../../node_modules/css-loader!../../../../../node_modules/postcss-loader/src??ref--80-2!../../../../../node_modules/sass-loader/dist/cjs.js??ref--80-3!./_theme-settings.scss */ "./node_modules/css-loader/index.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./resources/assets/vendor/js/_theme-settings/_theme-settings.scss");
...
var CONTROLS = ['rtl', 'style', 'layoutPosition', 'layoutNavbarFixed', 'layoutFooterFixed', 'layoutReversed', 'navbarBg', 'sidenavBg', 'footerBg', 'themes'];
var STYLES = ['light', 'material', 'dark'];
...
var ThemeSettings = /*#__PURE__*/function () {
  ...
  _createClass(ThemeSettings, [{
    ...
    key: "isLightStyle",
    value: function isLightStyle() {
      return document.documentElement.classList.contains('light-style');
    }
  }, {
    key: "isMaterialStyle",
    value: function isMaterialStyle() {
      return document.documentElement.classList.contains('material-style');
    }
  }, {
    key: "isDarkStyle",
    value: function isDarkStyle() {
    ...
    value: function setLang(lang) {
      ...
      ['panel_header', 'rtl_switcher', 'style_switcher_light', 'style_switcher_material', 'style_switcher_dark', 'layout_header', 'layout_static', 'layout_offcanvas', 'layout_fixed', 'layout_fixed_offcanvas', 'layout_navbar_swicher', 'layout_footer_swicher', 'layout_reversed_swicher', 'navbar_bg_header', 'sidenav_bg_header', 'footer_bg_header', 'theme_header'].forEach(function (key) {
    ...
    value: function _loadSettings() {
      ...
      this.settings.style = this.settings.styles.indexOf(style) !== -1 ? style : cl.contains('material-style') ? 'material' : cl.contains('dark-style') ? 'dark' : 'light';
      ...
      if (!this._hasControls('style')) {
        this.settings.style = cl.contains('material-style') ? 'material' : cl.contains('dark-style') ? 'dark' : 'light';
      }
    ...
    value: function _setup() {
      ...
      var styleW = this.container.querySelector('.theme-settings-style');

      if (!this._hasControls('style')) {
        styleW.parentNode.removeChild(styleW);
      } else {
        var _style = styleW.querySelector('select');

        this.settings.styles.forEach(function (styleItem) {
          var styleEl = _this2._getElementFromString("<option value=\"".concat(styleItem, "\" class=\"theme-settings-t-style_switcher_").concat(styleItem, "\" ").concat(_this2.settings.style === styleItem ? 'selected="selected"' : '', "></option>"));

          _style.appendChild(styleEl);
        });

        var styleCb = function styleCb(e) {
          _this2._loadingState(true);

          _this2.setStyle(e.target.value);
        };

        _style.addEventListener('change', styleCb);

        this._listeners.push([_style, 'change', styleCb]);
      } // Layout wrapper
      //
      ...
      if (!this._hasControls('themes')) {
        ...
        this.settings.availableThemes.forEach(function (theme) {
          ...
          var colors = _this2.isDarkStyle() ? theme.colorsDark : theme.colors;
          ...
          themeItem.querySelector('.theme-settings-theme-colors').innerHTML = "\n          <span style=\"background: ".concat(colors.primary, "\"></span>\n          <span style=\"background: ").concat(colors.navbar, "\"></span>\n          <span style=\"background: ").concat(colors.sidenav, "\"></span>\n        ");
    ...
    value: function _initStyle() {
      ...
      this._insertStylesheet('theme-settings-bootstrap-css', this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace('%name%', 'bootstrap' + (style !== 'light' ? "-".concat(style) : ''))));

      this._insertStylesheet('theme-settings-appwork-css', this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace('%name%', 'appwork' + (style !== 'light' ? "-".concat(style) : ''))));

      this._insertStylesheet('theme-settings-colors-css', this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace('%name%', 'colors' + (style !== 'light' ? "-".concat(style) : ''))));

      var classesToRemove = style === 'light' ? ['material-style', 'dark-style'] : style === 'material' ? ['light-style', 'dark-style'] : ['light-style', 'material-style'];
    ...
    value: function _initTheme() {
      if (this._hasControls('themes')) {
        this._insertStylesheet('theme-settings-theme-css', this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace('%name%', this.settings.theme.name + (this.settings.style !== 'light' ? "-".concat(this.settings.style) : ''))));
      }
    }
  }, {
